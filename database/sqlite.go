...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				disabled_image_generation_models TEXT DEFAULT '[]',
				...
				scheduler_mode TEXT DEFAULT 'round_robin',
					...
					codex_max_tools INTEGER DEFAULT 128,
					...
					codex_ws_auto_image_generation_enabled INTEGER DEFAULT 0,
	...
	columns := []struct {
		...
		{"system_settings", "codex_max_tools", "INTEGER DEFAULT 128"},
		...
		{"system_settings", "codex_ws_auto_image_generation_enabled", "INTEGER DEFAULT 0"},
		...
		{"system_settings", "disabled_image_generation_models", "TEXT DEFAULT '[]'"},
